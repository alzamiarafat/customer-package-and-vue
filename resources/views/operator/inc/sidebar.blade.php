...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview {{request()->routeIs(['operator.merchant.create','operator.merchant.index']) ? 'is-expanded' : ''}}">
            <a class="app-menu__item {{request()->routeIs(['operator.merchant.create','operator.merchant.index']) ? 'active' : ''}}" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Users</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li>
                    <a class="treeview-item {{request()->routeIs(['operator.merchant.create']) ? 'active' : ''}}" href="{{ route('operator.merchant.create') }}"><i class="icon fa fa-user-plus"></i> Add merchant</a>
                </li>
                <li>
                    <a class="treeview-item {{request()->routeIs(['operator.merchant.index']) ? 'active' : ''}}" href="{{ route('operator.merchant.index') }}" rel="noopener"><i class="icon fa fa-circle-o"></i> Merchant List</a>
                </li>
            </ul>
        </li>
        <li class="treeview">
